								...
								<div class="col-lg-4">
									...
									<div class="card">
										<a href="/"> <img src="/assets/img/역행자.jpg"
											class="card-img-top embed-responsive-item" alt="역행자"> <strong
											class="rank">1</strong>
									...
									<div class="card">
										<a href="/"> <strong class="rank">2</strong> <img
											...
											class="card-img-top embed-responsive-item" alt="헤어질결심">
											<div class="card-body" style="text-align: center">
												<small>[영화]</small>
									...
									<div class="card">
										<a href="/"> <strong class="rank">3</strong> <img
											...
											class="card-img-top embed-responsive-item" alt="호감말투">
											<div class="card-body" style="text-align: center">
												<small>[자기계발]</small>
												<h5 class="card-title">
									...
									<div class="card">
										<a href="/"> <img
											...
											class="card-img-top embed-responsive-item" alt="죄와벌"> <strong
											class="rank">4</strong>
											<div class="card-body" style="text-align: center">
												<small>[소설]</small>
									...
									<div class="card">
										<a href="/"> <strong class="rank">5</strong> <img
											...
											class="card-img-top embed-responsive-item" alt="죄와벌">
											<div class="card-body" style="text-align: center">
												<small>[소설]</small>
